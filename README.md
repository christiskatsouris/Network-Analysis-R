...
> A Dynamic Panel Data Model specification for the estimation problem under examination would indeed considered to be a good starting point. However, due to the presence of temporal dependence and possible network effects, the particular modeling approach would require additional refinements. Specifically, the given structure of the data, which are obtained sequentially through time (i.e., generated from the optimization step), implies that a more suitable estimation methodology can be found in the statistics literature on modeling methodologies for weakly dependent functional data. Some related frameworks are presented in the studies of [Kapar, B., & Olmo, J. (2022)](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4072928), [Olmo, J., & Sanso-Navarro, M. (2022)](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3578389) and Mancini, T., Calvo-Pardo, H., & Olmo, J. (2022c), while related statistical theory is proposed by [Hörmann, S., & Kokoszka, P. (2010)](https://projecteuclid.org/journals/annals-of-statistics/volume-38/issue-3/Weakly-dependent-functional-data/10.1214/09-AOS768.full).    
...
- Kapar, B., & Olmo, J. (2022). A dynamic network regression model for a large cross section of units with an application to measuring spillovers between pollution and electricity consumption. [Available at SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4072928).
...
- Mancini, T., Calvo-Pardo, H., & Olmo, J. (2022c). Environmental Engel Curves: A Neural Network Approach. Accepted in Journal of Royal Statistical Society - Series C.
- Olmo, J., & Sanso-Navarro, M. (2022). A Network Regression Model With an Estimated Interaction Matrix. [Available at SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3578389).
